...
## Sprite canon Lloyd ⭐⭐⭐⭐⭐ Sprite IA fully canon-conform 22-instance CONFIRMED + 4-form variant V1/V2/V3/V4 NEW MAJEUR FIRST documented Damia + LARGEST sprite-multi-form character Damia rule + Lloyd polished-branded "LLOYD - THE LEGEND OF DRAGOON" CONFIRMED 3-source canon récurrent récent expansion 3-instance avec Living Statue V2 + Lizard Man + Lloyd-Dragon-Burster polished-branded "LLOYD - DRAGON BURSTER - THE LEGEND OF DRAGOON" 2-line branding V3 + "LLOYD - DRAGON BURSTER - WINGLY - THE LEGEND OF DRAGOON" 3-line branding V4 = 3-tier branding-hierarchy FIRST + Wings-state-toggle V3/V4 Wingly-armor CONFIRMED 2-instance avec Lenus

⭐⭐⭐⭐⭐ **REVELATION SPRITE MAJEURE Damia : Lloyd 4-form sprite variant V1 Dragon Buster flaming sword (no armor) + V2 Normal silver sword (no armor) + V3 Dragon Burster Wingly armor (no wings deployed) + V4 Dragon Burster WINGLY (Wingly armor + cyan-energy wings DEPLOYED) + 7-animation MOST-COMPLEX 3-distinct ATTACK + Sprite IA fully canon-conform 22-instance CONFIRMED + Lloyd-Dragon-Burster Wingly-armor-without-wings-deployed V3 + Lloyd-Dragon-Burster WINGLY-WITH-WINGS-deployed V4 cyan-energy radiant-magical-form canon NEW MAJEUR FIRST documented Damia + Dragon Buster fire-elemental flaming-blade visual lore CONFIRMED canon récurrent récent + Polished branding "LLOYD - THE LEGEND OF DRAGOON" CONFIRMED 3-source + 3-tier branding-hierarchy 1-line/2-line/3-line FIRST + Wings-state-toggle V3/V4 Wingly-armor CONFIRMED 2-instance avec Lenus (sprites Lloyd V1/V2/V3/V4) ⭐⭐⭐⭐⭐**
...
⭐ **Sprite Lloyd 4-form base-utilisable Damia** :

- **V1 Dragon Buster flaming sword (base outfit)** = Disc 1+ Hellena 2nd Visit-Lavitz-killer + Disc 2 Fletz time-halt + Disc 2 Prison Island taunt-escape + Disc 3 Mountain of Mortal Dragon Divine-Dragon-finishing-blow (Multi-Strike + Dragon Impale + Wingly Magic + Wingly Purification + Energy Barrage)
- **V2 Normal silver sword (base outfit)** = Disc 1 Hero Competition Lohan scripted-tournament-encounter (Predictable Actions 9-action-sequence Single Slash + Multi Slash + Finishing Move)
...
- **V4 Dragon Burster WINGLY (Wingly armor + cyan-energy wings deployed)** = Disc 3 Tower of Flanvel boss-fight Lloyd-Wingly-MAX-power-form (wings-deployed = Wingly Magic / Wingly Purification / Energy Barrage usage states) OR Disc 4 Moon That Never Sets final-confrontation Melbu-Frahma + Lloyd-final-MAX-form pre-death (cohérent narrative final-power-release pre-laser-beam-death)

⭐⭐⭐⭐⭐ **Lloyd sprite 4-form fully canon-conform sprite-ready event-boss/antagonist base visuelle** + all wiki/fandom Lloyd narrative validated par 4 sprites variants (base-outfit + Dragon Buster + Wingly armor sans wings + Wingly armor + wings deployed + multi-disc-coherent visual progression) + ⭐⭐⭐⭐⭐ **4-form Lloyd = LARGEST sprite-multi-form character Damia rule expansion** = Lloyd richest sprite-coverage antagonist Damia + ⭐⭐⭐⭐⭐ **Wings-state-toggle V3/V4 Wingly-armor canon récurrent récent CONFIRMED 2-instance avec Lenus Damia rule expansion** + Damia design-flexibility wings-deployed-during-attacks vs wings-undeployed-during-non-attacks (cohérent Lenus pattern).
