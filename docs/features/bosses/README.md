...
| **Greham**       | **Wind (Jade Dragoon canon)** | **Hoax** — Greham = Jade Dragoon canon (Feyrbrand = son vassal Dragon) cf. [`../dragoons/dragons.md`](../dragoons/dragons.md)                                                                                   | ⚪ à spec     |
| Jiango           | ?                             | Black Castle                                                                                                                                                                                                    | ⚪ à spec     |
| Kongol (boss)    | Earth                         | Hoax / **Black Castle (Kazas)** — 2,000 XP / Wargod Calling 30% drop                                                                                                                                            | ⚪ à spec     |
| **Emperor Doel** | **Thunder**                   | **Black Castle (Kazas)** — 3,000 XP / **2-forme canon** (Emperor 600 HP humain + **Dragoon Doel** 1,800 HP) / **Thunder Barrier mécanique HP<50%** / reward Violet Dragon DS / **8/8 status immune dès Disc 1** | 🟡 draft      |
...
| **Lenus**               | **Water (Blue Sea Dragoon canon)** | Tiberoa / Prison Island — **Lenus = Blue Sea Dragoon canon** (Regole = son vassal Dragon) cf. [`../dragoons/dragons.md`](../dragoons/dragons.md) | ⚪ à spec                                    |
...
| **Dark Doel** | **Thunder** (Violet Dragoon)                      | **Moon That Never Sets** (Albert individual trial) — 1,500 HP / 6,000 XP / **2 swords entities séparées (Shadow Blade + Light Sword)** + **Lightning Cape** post-swords / cf. [`./Emperor Doel.md`](./Emperor Doel.md) §Dark Doel Moon | 🟡 draft (via Doel)                      |
