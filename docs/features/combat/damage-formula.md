...
| **3. Item Magic — Multi Items**              | `floor{floor[(LV+5) × MAT × 5 / MDF] × BID/100}` (+ wrapper spécial)                           | Multiplier% mashing entre Element et Target Fear                                                     |
| **4. Item Magic — Powerful / Detonate Rock** | `floor{floor[(LV+5) × MAT × 5 / MDF] × BID/100}`                                               | Wrapper standard                                                                                     |
...
- **Source canon** : [`_sources/wulves-tlod-damage-formulas.md`](./_sources/wulves-tlod-damage-formulas.md)
- **Modifiers détaillés** : [`damage-modifiers.md`](./damage-modifiers.md) (à créer — Power/Field/Element variables)
