# Dragon Block Staff — Key Item Wingly artifact Disc 3

> **Key Item Wingly artifact canon** anti-Dragon + anti-Dragoon. **Quest object Disc 3** : Dart's party retrieve from Forest of Winglies/Kadessa ruins → stop Divine Dragon. **Sealed Divine Dragon 10,000+ years** canon (cohérent existing Divine Dragon lore). Passed down generations of Winglies + hidden Kadessa (former Wingly capital, "Forbidden Land" present).
>
> ⭐⭐⭐ **Dragon Block Staff effects PER-BATTLE variable canon NEW MAJEUR** :
>
> - **Grand Jewel battle** (Kadessa guardian) : Dragoons 10% damage dealt / 10× damage received (reactive trigger if Dragoons used)
> - **Divine Dragon battle** (Mountain of Mortal Dragon Disc 3) : Dragoons **40% dmg / 4× received** ✓ confirmé wiki Divine Dragon canon. Dart activates start battle → Staff **BREAKS** (last time ever used canon)
> - **Melbu Frahma final phase** (Disc 4 final boss) : Dragoons 10% / 10× (reactive trigger Dragoon Magic attack — Wingly magic intrinsic, Staff already broken)
>
> ⭐⭐⭐ **Pattern healing + defensive Dragoon Magic NOT affected canon** — supportive Dragoon Magic strategy canon (Albert Rose Storm / Meru Rainbow Breath / Miranda healing) cohérent Divine Dragon strategy.
>
...
- **Espèce** : Dragon Block Staff (Wingly magical artifact)
- **Category** : **Key Item** Disc 3 (story-essential)
- **Origin** : Created by ancient Winglies (millennia ago canon)
- **Function** : Anti-Dragon + Anti-Dragoon — diminishes both Dragons + Dragoons power canon
- **Storage canon** : Hidden in **Kadessa** (former Wingly capital, "Forbidden Land" present)
- **Acquisition** : Disc 3 Dragon Block Staff quest (Forest of Winglies → Kadessa ruins → Grand Jewel guardian boss)
- **Pattern symbolique** : ⭐ **Wingly anti-Dragon weapon pair canon** : **Dragon Block Staff** (reduces power) + **Dragon Buster** (sword — lost canon Disc 3, Lloyd gives Dart Disc 4)
...
## Story canon Disc 3 acquisition ⭐⭐⭐ MASSIVE
...
- **Wingly Forest hostility** then **Ancestor Blano permits entry**
- **Blano canon dialogue** : "Times won't leave Winglies alone" + must combine strengths
- **"Winglies can no longer master the Staff"** canon → Dragoons may use canon NEW
- **Dragon Buster LOST canon** ⭐ (Forest of Winglies reveal — separate from Staff still safe)
- **Wingly teleportation system** : Blano + Winglies channel magic to send party to Kadessa ruins

### Kadessa ruins acquisition

- Party navigates grand ruins (Dragon Campaign-era canon)
- Staff embedded in large rocky formation chamber
- **Miranda** : "doesn't appear impressive"
- **Rose canon quote** : "the appearance of an object doesn't correlate to its magical prowess"
- **Rose canon reveal** : "Divine Dragon was sealed because it could not be tamed nor killed" ✓ cross-source confirmed
- Meru tries retrieve Staff → rumbling → ceiling object dislodges → **Grand Jewel boss appears** canon
...
- À documenter `npcs/Luanna.md` (à créer) — 2nd Sacred Sister Mille Seseau magic-sensitive NPC NEW canon

### Mountain of Mortal Dragon battle Disc 3

- Party races to Mountain
...
- Party victorious → Lloyd claims Divine Dragoon Spirit
- **Dragon Block Staff broke canon** : last time ever used canon ⭐⭐⭐

## Use in Combat ⭐⭐⭐ MASSIVE per-battle variable effects

Dragon Block Staff **always diminishes Dragoons + Dragons power**. **Exact effects vary per battle** canon. Pattern **healing + defensive Dragoon Magic NOT affected** canon (cohérent existing Divine Dragon strategy supportive Dragoon Magic).
...
### Grand Jewel battle effect canon ⭐⭐⭐

- **Dragoons 10% damage dealt + 10× damage received** canon
...
### Divine Dragon battle effect canon ✓ cross-source confirmed ⭐⭐⭐

- **Dragoons 40% damage dealt + 4× damage received** canon ✓ wiki Divine Dragon confirmé
- **Staff breaks at activation** + **effects permanent entire battle** canon
- **Divine Dragon real stats higher than displayed** canon (stats reflect weakened state)
...
### Melbu Frahma final phase effect canon ⭐⭐⭐

- **Dragoons 10% damage dealt + 10× damage received** canon
- **Reactive trigger** : Melbu Frahma final phase + Dragoon Magic attack target → activates ability canon
- ⚠️ Pattern : Staff broken Disc 3 — Melbu Frahma uses Wingly magic intrinsic (not physical Staff) canon
- Pattern Damia : `DragonBlockStaffMelbuFrahmaEffect { dragoonDamageDealt: 0.10; dragoonDamageReceived: 10; reactiveTrigger: 'dragoon-magic-attack-target'; sourcePhase: 'final-phase' }` data-model canon

## Pattern Wingly anti-Dragon weapons canon ⭐⭐⭐ MAJEUR

Pattern Wingly anti-Dragon weapons canon Damia confirmed cross-source :

- **Dragon Block Staff** = Wingly artifact reduces Dragon + Dragoon power canon (variable effects 10%/40%)
- **Dragon Buster** = Wingly sword anti-Dragon canon (Dart ultimate weapon Disc 4 from Lloyd — probable killing dragons)
- Pattern Wingly civilization canon : ancient anti-Dragon weapons creation canon
- À documenter `dragoons/wingly-anti-dragon-weapons.md` (à créer) — pattern canon récurrent + items list

## Vision Damia (implémentation)

### Décisions canon à conserver

1. **Dragon Block Staff = Wingly Key Item canon Disc 3** : acquisition Forest of Winglies + Kadessa ruins
2. **Sealed Divine Dragon 10,000+ years canon** : cross-source confirmed
3. **Hidden Kadessa = former Wingly capital "Forbidden Land" present canon** NEW MAJEUR
4. **Variable per-battle effects canon** : Grand Jewel 10%/10× / Divine Dragon 40%/4× / Melbu Frahma 10%/10×
5. **Staff breaks at Divine Dragon activation canon** : last time ever used (single-use Disc 3)
6. **Healing + defensive Dragoon Magic NOT affected** : pattern supportive Dragoon Magic strategy canon
7. **Grand Jewel boss canon NEW** : Wingly guardian Kadessa ruins
8. **Ancestor Blano canon NEW** : Wingly elder Forest of Winglies leader
9. **Dragon Buster LOST canon Disc 3** : Forest of Winglies reveal (separate item, found later Disc 4 via Lloyd)
10. **Pattern Wingly anti-Dragon weapons canon** : Dragon Block Staff + Dragon Buster pair canon
...
- Data-model `DragonBlockStaffKeyItem` :
  ```ts
  type DragonBlockStaffKeyItem = {
    type: 'wingly-anti-dragon-artifact';
    acquisitionDisc: 3;
    breaksAfter: 'divine-dragon-battle'; // single-use canon
    variableEffectsPerBattle: {
      grandJewel: { dragoonDamageDealt: 0.1; dragoonDamageReceived: 10; trigger: 'dragoon-used' };
      divineDragon: {
        dragoonDamageDealt: 0.4;
        dragoonDamageReceived: 4;
        trigger: 'manual-activation-start-battle';
      };
      melbuFrahma: {
        dragoonDamageDealt: 0.1;
        dragoonDamageReceived: 10;
        trigger: 'dragoon-magic-attack-target-final-phase';
      };
    };
    affectsHealingDefensiveDragoonMagic: false; // strategy supportive Dragoon Magic
    activationVFX: {
      color: 'eerie-green';
      effect: 'tornado-absorbs-draconic-power';
      animation: 'dart-holds-staff-up';
      result: 'staff-breaks-then-weakens-both';
    };
  };
  ```
...
- **Dragon Buster canon item** : à ingérer fandom future (Lloyd gives Dart Disc 4 — probable Dart ultimate weapon)
- **Forest of Winglies location canon** : à ingérer wiki + fandom future Disc 3 area
- **Dragon Block Staff sprite design Damia** : visual canon à investiguer fandom future + Guidebook ?
- **Pattern variable effects mechanic Damia implementation** : per-battle Staff effect data-model canon

## Liens transverses

- [`README.md`](./README.md) (à créer) — items canon catalog
- [`../bosses/Divine Dragon.md`](../bosses/Divine Dragon.md) — Dragon Block Staff usage Divine Dragon battle canon ✓ confirmé
- [`../bosses/Grand Jewel.md`](../bosses/Grand Jewel.md) (à créer) — Wingly guardian boss canon Kadessa ruins NEW
- [`../bosses/Melbu Frahma.md`](../bosses/Melbu Frahma.md) (à créer/vérifier) — Disc 4 final boss + Dragon Block Staff ability final phase canon
- [`../locations/Kadessa.md`](../locations/Kadessa.md) (à créer) — Forbidden Land former Wingly capital canon NEW
...
- [`../party-members/Dart.md`](../party-members/Dart.md) — activates Staff Divine Dragon battle + receives Dragon Buster Lloyd Disc 4
- [`../bosses/Lloyd.md`](../bosses/Lloyd.md) (à créer/vérifier) — Disc 3-4 boss + gives Dart Dragon Buster Disc 4
- [`Dragon Buster.md`](./Dragon Buster.md) (à créer) — Wingly sword anti-Dragon canon pair Dragon Block Staff
- [`../dragoons/dragons.md`](../dragoons/dragons.md) — Wingly anti-Dragon weapons canon reference
- [`../dragoons/wingly-anti-dragon-weapons.md`](../dragoons/wingly-anti-dragon-weapons.md) (à créer) — pattern canon récurrent Dragon Block Staff + Dragon Buster

## Gaps / TODO

Voir [TODO.md](../../TODO.md) section Dragon Block Staff.
