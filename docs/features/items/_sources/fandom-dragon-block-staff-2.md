# Dragon Block Staff — fandom (verbatim — seconde source lore-focused)

> **Source** : fandom Dragon Block Staff page (lore-focused — sections Story / Gallery / Trivia)
> **Fiabilité** : 🥉 **tier 3** (fandom — lore canon complémentaire première source fandom).
> **Sauvegardé le** : 2026-05-25.
> **Usage** : référence canon Dragon Block Staff **lore complémentaire** (vs gameplay-focused première fandom source `fandom-dragon-block-staff.md`). ⭐⭐⭐ **NEW canons MAJEURS** : **Luanna 2nd Sacred Sister Mille Seseau canon** (lit énergie Staff → "huge tornado of energy that absorbs everything"). + ⭐⭐ **Rose recommendation canon** (Dart's group decides search Staff upon **Rose recommendation** — vs existing fandom "Meru reveals location"). + ⭐⭐ **Staff visual canon** : "glows **eerie green** before suddenly breaking" — animation/VFX canon. + ⭐⭐ **Trivia theory canon** : Dragon Block Staff = force behind Divine Dragon sealing (theory — unclear why Staff breaks Divine Dragon battle — could not contain ferocity 'King of Dragons' completely + shattered absorbing too much power). + ⭐ **Ancestor Blano reveals Dragon Buster lost canon** (confirms existing canon — Blano's revelation specifically).
...
- "Legendary artifact" canon (vs "magical Wingly artifact" première fandom)
...
Fandom article complet (no stub note) — Lore-focused complément première fandom source gameplay-focused.
