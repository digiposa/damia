...
> **Mob Wind element Evergreen Forest Disc 3 Mille Seseau** — Flying-type mob (Wind themed) qui paradoxalement **cast Spear Frost = Water-elemental magic damage** ≤ 50% phase. 3 formations Evergreen Forest submaps 339-345 + **6 World Map roads Mille Seseau** (Furni/Neet/Mountain Mortal Dragon/Intersection/Deningrad/Kashua Glacier — massive World Map presence canon).
>
> ⭐⭐⭐ **Mismatched element ability canon NEW MAJEUR ⭐⭐⭐** — Flying Rat = **Wind mob** mais Spear Frost = **Water-elemental magic damage** ⚠️. Pattern Damia : **mob element ≠ ability element** canon NEW — element du mob ne dicte pas systématiquement l'élément de ses abilities. À investiguer cross-mob (autres mobs avec mismatched element abilities ?).
>
> ⭐⭐⭐ **Spear Frost canon name officiel NEW ⭐⭐⭐** — Wiki nomme officiellement ability ≤ 50% "Spear Frost" (not approximate ~ name). Pattern partial-canon naming (cohérent Berserk Mouse Chisel ≤ 50% canon-named pattern). 1.5× Water magic single target damage.
>
...
>
> ⭐⭐ **JP HP 300 +15% divergence pattern systematic +25% ⚠️** — wiki US 260 / fandom JP 300 = +15% (existing Evergreen Forest HP/JP table). Pattern Damia : **+15% anomaly Flying Rat** vs typical +25% systematic JP scaling. À investiguer fandom + Discord — cohérent recent Evil Spider +67% anomaly (mob-specific JP scaling exception canon).
>
> ⭐⭐ **JP Gold 8 ÷3 systematic CONFIRMED** (US 24 / JP 8 = ÷3 ✓ exact pattern Damia +25% HP / ÷3 Gold canon).
>
...
>
> ⭐⭐ **A-AV 20% canon** — moderate physical avoidance (cohérent Erupting Chick A-AV 20% high tier).
>
> ⭐⭐ **AI 2-phase canon récurrent** : ~Cling (>50% 1× phys single) → Spear Frost (≤50% 1.5× Water magic single).
>
...
🟡 **Canon documenté wiki tier 2 uniquement** — fandom à ingérer future (HP US/JP confirmation + appearance + JP name + recolor potential + ability canon names confirmation).
...
| Stat | Value | Notes                                                 |
| ---- | ----- | ----------------------------------------------------- |
| HP   | 260   | US/EU (JP 300 = +15% anomaly vs +25% canon)           |
| AT   | 38    | Moderate physical attack                              |
| DF   | 80    | Low defense                                           |
| MAT  | 54    | Higher than AT — magic-focused                        |
| MDF  | 120   | High magic defense                                    |
| SPD  | 60    | Moderate speed                                        |
| A-AV | 20%   | Moderate physical avoidance (cohérent Erupting Chick) |
| M-AV | 0%    | No magic avoidance                                    |

→ Pattern : **MAT 54 > AT 38** + **MDF 120 > DF 80** = **magic-focused mob** canon. Spear Frost ≤50% reveals magic primary role. **A-AV 20%** moderate physical avoidance cohérent aerial flying thematic.
...
| ---- | --------------- | ------ | ----------------------------------------------------------------- |
| >50% | ~Cling          | Single | 1× Physical damage (community approximation name)                 |
| ≤50% | **Spear Frost** | Single | **1.5× Water-elemental magic damage** ⚠️ MISMATCHED ELEMENT canon |

⭐⭐⭐ **Mismatched element ability canon NEW MAJEUR** :

- **Flying Rat = Wind element** mob
- **Spear Frost = Water-elemental magic damage** ability
...
- **Spear Frost** = canon name officiel ≤ 50% (NOT community ~ approximate)
- Pattern partial-canon naming (cohérent Chisel ≤ 50% Berserk Mouse + Stomp the Ground Earth Shaker partial-canon pattern)
- Thematic "Frost spear" = aerial ice-spear strike canon
- Damage type : **1.5× Water-elemental magic damage single target**

### ~Cling canon ⭐ partial

- **~Cling** = community approximation name (NOT canon)
- Thematic : aerial rat clings to single target physical damage
- > 50% phase ability
...
2. AI cycle :
   - HP > 50% (>130) : ~Cling (1× phys single)
   - HP ≤ 50% (≤130) : **Spear Frost** (1.5× **Water magic** single — mismatched element)
3. Counter mechanism (Counter Opportunities 28 high-density tier — 15 combos détaillés)
4. Escape 30% accessibility moderate Disc 3 forest pattern

### Strategy canon recommandée

- **Wind mob weak to Earth element** (canon TLoD elemental wheel)
- ⚠️ **Spear Frost = Water elemental** (NOT Wind) → resistant party Water spells/items pour ≤ 50% phase canon NEW MAJEUR
- **Magic-focused mob** (MAT 54 > AT 38) → spell-based threat ≤ 50%
- **A-AV 20%** moderate → some physical attacks missed
- **HP 260 burst-kill priority** = prévenir Spear Frost phase 2 swap (1.5× Water magic high damage)
...
1. **Stats canon exacts wiki** : HP 260 (US, JP 300) / AT 38 / DF 80 / MAT 54 / MDF 120 / SPD 60 / A-AV 20% / M-AV 0%
...
4. ⭐⭐⭐ **Spear Frost canon name officiel** : 1.5× Water magic single target ≤ 50%
5. ⭐⭐⭐ **6 World Map roads Mille Seseau canon** : massive World Map presence Disc 3
6. ⭐⭐⭐ **Asymmetric road encounter Mountain Mortal Dragon → Evergreen excluded** canon NEW : directional encounter logic
7. **Counter 28 universal multi-disc tier** confirmed (3ème instance après Berserk Mouse + Aqua King + Archangel)
8. **Status 4/4 standard Minor Enemy** canon
9. **2-phase AI** : ~Cling > 50% / Spear Frost ≤ 50%
10. **Angel's Prayer 8% drop** : revive item pattern récurrent Wind mobs Disc 2-3
11. **Escape 30%** : Disc 3 Evergreen Forest pattern
12. **3 formations Evergreen Forest** : solo + Forest Runner partner + ×2+Dark Elf trio
13. **Submap 341 hotspot** : Flying Rat dominant location Evergreen Forest
...
- **Flying Rat appearance canon** : aerial rat type design (bat-rat hybrid ? winged rat ? rodent dragon-like ?) à confirmer fandom future.
- **JP HP 300 +15% anomaly** : confirmer fandom + pourquoi +15% vs +25% systematic canon Damia (pattern mob-specific exception cohérent Evil Spider +67% anomaly récent).
