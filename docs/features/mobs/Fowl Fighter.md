...
- **Nom** : Fowl Fighter (pun canon Trivia)
- **Espèce** : **Recolor of Assassin Cock canon CONFIRMED** — Fire variant of Wind parent (Forest Disc 1 → Hellena Prison Disc 1)
- **Appearance canon NEW MAJEUR** : **Bird with blades equipped on feet for slashing foes with kicks**
- **Element** : **Fire** ⭐ (recolor element shift vs parent Assassin Cock Wind canon)
- **Location canon** : **Hellena Prison submap 33** (Disc 1 Serdio chain #3) — UNIQUE encounter location
- **Disc** : Disc 1 Serdio
...
Pattern standard Minor Enemy 4/4 canon. ⚠️ **Self-immunity to inflicted status CONTRADICTION** : Fowl Fighter inflicts Fear via ~Scream + Fowl Fighter Fear vulnerable ✗ (PAS self-immune comme Forest Runner Bewitchment). Pattern Damia : self-immunity NOT systematic canon — investiguer cross-mob.

## Yield canon

- **EXP : 16** / **Gold : 9** (Hellena Prison Disc 1 mid-tier)
- **Drop : Mind Purifier 8%** — Confuse/Bewitchment cure item canon (cohérent existing Erupting Chick fandom canon Mind Purifier 20G shop pattern récurrent)

## Counter Opportunities ⭐⭐ 19 mid-density (2ème instance CONFIRMED)

**(19)** — pattern standard Counter Yes mid-density tier canon **2ème instance CONFIRMED** (Assassin Cock parent 19 + Fowl Fighter recolor 19 — **recolor inherits Counter tier canon NEW MAJEUR** pattern). 12 button-press combos détaillés.

### 12 button-press combos détaillés (Counter feature non-implémentée Damia per user instruction)
...
| ---------------- | ----- | ----------------------------------------------------------------------------------------------- |
| **High density** | 28    | Aqua King / Archangel / Berserk Mouse / Flying Rat / Forest Runner                              |
| **Mid density**  | 19    | Assassin Cock / **Fowl Fighter** ⭐ (recolor inherits parent canon)                             |
...
- Pattern Damia : M-AV reduces status chance canon récurrent (cohérent Flabby Troll + Forest Runner Wooing/Menacing + Fowl Fighter Scream)
- Fowl Fighter = **4ème confirmation cross-mob M-AV reduces status** canon récurrent

## Encounters canon ⭐⭐⭐ Contact-only formation 484 UNIQUE

| Formation                                        | Submap            | Encounter Rate | Escape% |
| ------------------------------------------------ | ----------------- | -------------- | ------- |
| Fowl Fighter ×2 + **Hellena Warden (2nd)** (484) | Hellena Prison 33 | **Contact**    | **0%**  |

⭐⭐⭐ **Contact-only encounter canon NEW MAJEUR** :

- **Contact encounter** (NOT random) = scripted forced fight canon
- **0% escape** = no escape allowed canon
- **UNIQUE submap 33** Hellena Prison Disc 1
- **Hellena Warden (2nd)** boss formation partner NEW MAJEUR (parent Hellena Warden 1st canon existing — 2nd canon NEW)
- Pattern Damia : scripted boss-companion encounter canon Disc 1 Hellena Prison

### World Map Roads : None canon

Pattern Damia : Hellena Prison-only encounter mob canon (NOT roaming).

## Combat flow canon

1. Scripted Contact encounter Hellena Prison submap 33 (NOT random)
2. AI cycle 3-phase :
   - HP > 50% : ~Kick (1× phys single)
   - HP ≤ 50% : ~Continuous Kick (2× phys single)
   - Any phase : **~Scream Party** (1× Non-Elemental magic + 50% Fear)
3. Counter mechanism (Counter Opportunities 19 mid-density tier — 12 combos)
4. **0% escape** = forced fight canon

### Strategy canon recommandée

- **Fire mob weak to Water element** (canon TLoD elemental wheel)
- ⭐⭐⭐ **Burst-kill priority HP > 50%** = prévenir ~Continuous Kick phase (2× damage high)
- ⭐⭐⭐ **~Scream Party AoE Fear threat** = M-AV stacking strategy + Fear-resistant accessories
- **High MDF 120 → Additions more efficient vs magic spells** canon récurrent (cohérent Forest mobs MDF mystery)
- **A-AV 10% low** = physical attacks reliably hit
- Counter Opportunities 19 = moderate trigger windows pour player Additions
- ⭐⭐⭐ **Hellena Warden (2nd) priority threat** = kill boss companion first probable

## Vision Damia (implémentation)

### Décisions canon à conserver

1. **Stats canon wiki** : HP 100 / AT 16 / DF 80 / MAT 19 / MDF 120 / SPD 60 / A-AV 10% / M-AV 0%
2. **Fire element canon** : tagging mob Damia Fire
3. ⭐⭐⭐ **Recolor of Assassin Cock canon CONFIRMED** : Fire/Wind element shift recolor variant
4. ⭐⭐⭐ **Bird blades equipped feet for slashing kicks canon appearance NEW MAJEUR**
5. ⭐⭐⭐ **AI 3-phase canon NEW MAJEUR** : ~Kick / ~Continuous Kick 2× / ~Scream Party Non-Elemental + 50% Fear
6. ⭐⭐⭐ **2× damage multiplier ~Continuous Kick canon NEW MAJEUR** (rare canon Minor Enemy)
7. ⭐⭐⭐ **~Scream Party AoE Non-Elemental + 50% Fear canon NEW MAJEUR**
8. ⭐⭐⭐ **M-AV reduces status proc canon 4ème instance** confirmed récurrent
9. ⭐⭐⭐ **Contact-only encounter formation 484 + Hellena Warden (2nd) 0% escape forced fight canon NEW MAJEUR**
10. ⭐⭐⭐ **Hellena Warden (2nd) boss canon NEW MAJEUR** (parent Hellena Warden existing canon — 2nd encounter NEW)
11. **Counter 19 mid-density tier 2ème instance CONFIRMED** — recolor inherits parent Counter tier canon NEW MAJEUR pattern
12. **Status 4/4 standard Minor Enemy** canon
13. ⚠️ **Self-immunity to inflicted status CONTRADICTION** : Fowl Fighter inflicts Fear + Fear vulnerable (NOT self-immune comme Forest Runner)
14. **Mind Purifier 8% drop** canon (Confuse/Bewitchment cure item)
15. **UNIQUE submap 33 Hellena Prison location** canon
16. **No World Map roads** : Hellena Prison-only canon
17. **"Name pun" Trivia canon** (Fowl/Foul probable)

### Implementation tech

- Data-model `RecolorMobInheritance` :
  ```ts
  type RecolorMob = {
    parentMobId: string; // 'assassin-cock'
    elementShift?: Element; // 'fire' (vs parent 'wind')
    statScaling?: 'scaled-up' | 'scaled-down';
    inheritsCounter?: boolean; // true: Counter tier inherited from parent
  };
  // Fowl Fighter : { parentMobId: 'assassin-cock', elementShift: 'fire', statScaling: 'scaled-up', inheritsCounter: true }
  ```
- Data-model `ContactEncounter` :
  ```ts
  type EncounterFormation = {
    type: 'random' | 'contact' | 'scripted';
    escapeRate: number; // 0 for forced fight
  };
  // Fowl Fighter formation 484 : { type: 'contact', escapeRate: 0 }
  ```

### Questions ouvertes

- ⭐⭐⭐ **Hellena Warden (2nd) boss canon depth** : différences vs Hellena Warden (1st) ? Stats / abilities ? À ingérer wiki+fandom Hellena Warden + Hellena Prison location future.
- ⭐⭐⭐ **Recolor Counter tier inheritance pattern systematic ?** : autres recolors inherit Counter tier ? À cross-check (Plague Rat vs Berserk Mouse / Stinger vs Crescent Bee / Specter vs Fire Spirit Counter tiers).
- ⭐⭐⭐ **Element shift recolor pattern systematic ?** : autres recolors with element shift canon ? À cross-check (parent Assassin Cock Wind → Fowl Fighter Fire — pattern récurrent ?).
- ⭐⭐⭐ **Self-immunity to inflicted status pattern non-systematic** : Forest Runner self-immune Bewitchment + Fowl Fighter NOT self-immune Fear — pattern divergent canon. À investiguer Discord + cross-mob systematic.
- ⭐⭐ **Fowl Fighter appearance canon depth** : Assassin Cock recolor visual + blade-feet — à confirmer fandom + sprite design Damia.
- ⭐⭐ **JP stats Fowl Fighter** : HP/Gold confirmations fandom future.
- ⭐⭐ **Name pun canon** : Fowl/Foul probable — à confirmer fandom Trivia.
- ⭐ **Continuous Kick canon name** : community approximation — fandom canon name à confirmer.
- ⭐ **Scream canon name** : community approximation — fandom canon name à confirmer.

## Liens transverses

- [`README.md`](./README.md) — pattern général mobs canon
- [`Assassin Cock.md`](./Assassin Cock.md) — parent mob Forest Disc 1 Wind canon (Fowl Fighter Fire recolor)
- [`../locations/Hellena Prison.md`](../locations/Hellena Prison.md) (à créer) — Disc 1 #3 chain Serdio (UNIQUE encounter Fowl Fighter submap 33)
- [`../bosses/Hellena Warden.md`](../bosses/Hellena Warden.md) (à créer) — Hellena Prison boss canon récurrent
- [`../bosses/Hellena Warden 2nd.md`](../bosses/Hellena Warden 2nd.md) (à créer) — 2nd encounter formation 484 boss canon NEW MAJEUR
- [`Plague Rat.md`](./Plague Rat.md) (à créer) — recolor of Berserk Mouse canon (cross-ref recolor pattern récurrent)
- [`../combat/recolor-mob-families.md`](../combat/recolor-mob-families.md) (à créer) — recolor canon récurrent (5+ instances documented)
- [`../combat/additions.md`](../combat/additions.md) — Counter Opportunities tier mapping (19 mid-density 2ème instance recolor inheritance canon NEW)
- [`../combat/status-effects.md`](../combat/status-effects.md) (à créer) — Fear status + M-AV reduces canon 4ème instance
- [`../combat/elements.md`](../combat/elements.md) — Fire element + Non-Elemental ability mismatched element pattern
- [`../items/Mind Purifier.md`](../items/Mind Purifier.md) (à créer) — Confuse/Bewitchment cure canon récurrent

## Gaps / TODO

Voir [TODO.md](../../TODO.md) section Fowl Fighter.
