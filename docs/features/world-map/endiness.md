...
🟡 **draft** — foundational world map lore canon ingéré.

## Profil

| Attribut              | Valeur                                                                                                              |
| --------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Type                  | **Continent canon TLoD** (master geography)                                                                         |
| Realm canon           | **Tesfer Realm** ⚠️ NEW (encompasses world)                                                                         |
| Planet name canon     | **Never given** (trivia)                                                                                            |
| Forme géographique    | **Peninsula** anchored to land east, surrounded W/S/N by Fourtos Ocean + Aquaria Coral Reef                         |
| Régions territories   | **4 canon** : Serdio + Tiberoa + Mille Seseau + Gloriano (partial scorched = Death Frontier)                        |
| Iles canon            | **Broken Islands** (south, ripped Dragon Campaign), **Suncrest Island** (Regole canon), Prison Island (Lenus canon) |
| Lands east unexplored | **6 canon** : Azeel + Ediroso + Losta + Nissel + Seilnder + Vidalio (visible world map only)                        |
| Historique            | **>11,000 ans canon** depuis le seed Soa Divine Tree                                                                |

## History canon (master Endiness)

### Age of Winglies (>11,000 ans pre-game)

1. **Initial state** : world **completely barren + devoid of life**
2. **Soa plants seed** → **Divine Tree grows** → **108 fruits** = unique species each
3. **107th fruit = Winglies** canon — born intelligence + vast magical power, capable wondrous feats
4. **Winglies suspended birth of 108th species** canon (cohérent Crystal Sphere harness Virage Embryo)
5. Some Winglies = peace/equality vision ; **many treated other species as playthings**
6. Humans found **Holy Empire of Gloriano** as **seat of rebellion** canon
7. Dragoon Spirit discovery (eye-merge canon) → war prep

### Dragon Campaign (~11,000 ans pre-game)

- **War backwash magical power** **laid waste to Gloriano** → **changed landscape to deadly desert = Death Frontier** canon ⚠️ confirme + précise
- **Large island south ripped apart** → **Broken Islands** canon ⚠️ NEW canon location
- Climax : **Dragoons assault Kadessa Royal Capital** → crashed to ground
- Most Dragoons died, Wingly dictator (Melbu Frahma) defeated
- **Surviving Winglies surrender** + grant Humans **3 magical artifacts** (= 3 Divine Moon Objects canon)
- **Winglies hide with magic** (fear hostility/annihilation) → cohérent Forest of Winglies + Aglis underwater + Ulara hidden + Zenebatos canon

### Age of Humans (Present Day = TLoD time)

- Humans divide continent into **4 regions** :
  - **Serdio** (Disc 1 — Basil north + Sandora south civil war)
  - **Tiberoa** (Disc 2 — Donau Flower City + Fletz King Zior + Twin Castle)
  - **Mille Seseau** (Disc 3 — Deningrad capital, Sacred Sisters, state religion Divine Tree worship)
  - **Gloriano** (north-west, partial = Death Frontier south, partial ruins north)
- **Death Frontier left untouched** (uninhabitable post-scorch)
- **Gloriano north** retains **ruins canon** (vestige Holy Empire ancient)
- 11k ans relative peace until **Serdian War re-ignited Disc 1** (Doel/Diaz/Lloyd conspiracy)
...
| Region                              | Discs canon | Capital / Highlights canon                                                              | Statut canon                      |
| ----------------------------------- | ----------- | --------------------------------------------------------------------------------------- | --------------------------------- |
| **Serdio**                          | Disc 1      | **Bale** (Basil capital, Albert) + **Kazas** (Sandora capital, Black Castle, Doel)      | Civil war (Bale vs Sandora)       |
| **Tiberoa**                         | Disc 2      | **Fletz** (capital, King Zior) + **Donau** (Flower City) + Twin Castle + Lenus arc      | Peace + sea trade                 |
| **Mille Seseau**                    | Disc 3      | **Deningrad** (capital, Theresa, Crystal Palace) + Sacred Sisters + state religion      | Divine Dragon attack (Disc 3 mid) |
| **Gloriano** (north partial)        | Disc 4 ?    | **Ruins canon** (former Holy Empire) — Vellweb (Liberation Army capital, anciens souls) | Ruined / sacred memorial          |
...
### Gloriano vs Death Frontier canon distinction

- **Death Frontier** = "**lesser title**" of Gloriano per wiki canon
- **Northern Gloriano** retains **ruins** → still called Gloriano
- **Southern desert** = ce qui est appelé Death Frontier specifically
- Pattern : **2 zones canon dans ce qui était l'ancien Holy Empire of Gloriano** :
  1. North = Gloriano (ruins canon, Vellweb probable, Fort Magrad probable)
  2. South = Death Frontier (désert canon)

### Planet name unknown canon

- Continent Endiness + Realm Tesfer connus
- **Planet name never given** canon trivia ⚠️
- Lore mystère — possible reveal future content ou simplement design choice

## Vision Damia

### Mode Story

- **Master world map TLoD** = à reproduire avec fidélité canon
- **Peninsula anchored east** = navigation primary continent
- **Fourtos Ocean + Aquaria Coral Reef** = sea travels (Queen Fury routes Donau-Fueno + Donau-Furni)
- **6 lands east unexplored** = visible mais inaccessible canon → fidélité canon ou unlock late-game expansion
- **4 regions canon** = navigation Disc 1→2→3→4 progressive
- **Broken Islands canon** = location ripped Dragon Campaign possibly explorable (Disc 4 ?)

### Mode Survival

- **Theme arènes par region canon** : Serdio (forest), Tiberoa (sea), Mille Seseau (winter/Crystal), Gloriano (ruins), Death Frontier (desert), Broken Islands (fragmented)
- **6 lands east** = hooks pour Mode Survival exclusive arènes (Damia adaptation expansion)
- **Tesfer Realm** = "world" wrapper concept Survival lore

### À implémenter (impact code)

- **World map data-model** : `Continent.regions[]` + `Region.locations[]` + `Region.parent: continent`
- **Sea bodies** : Fourtos Ocean + Aquaria Coral Reef visual rendering
- **Navigation** : peninsula east anchor + ship routes canon
...
- **Locations master index** : [`../locations/README.md`](../locations/README.md)
- **Dragon Campaign (geography-shaping)** : [`../dragoons/dragon-campaign.md`](../dragoons/dragon-campaign.md)
- **Dragons + Divine Tree (creation)** : [`../dragoons/dragons.md`](../dragoons/dragons.md) + [`../locations/Divine Tree.md`](../locations/Divine Tree.md)
- **Specific regions** :
  - Serdio : [`../locations/Bale.md`](../locations/Bale.md) + [`../locations/Kazas.md`](../locations/Kazas.md) + [`../locations/Nest of Dragon.md`](../locations/Nest of Dragon.md)
  - Tiberoa : [`../locations/Donau.md`](../locations/Donau.md) + Fletz/Twin Castle (à créer)
  - Mille Seseau : [`../locations/Deningrad.md`](../locations/Deningrad.md)
  - Gloriano + Death Frontier : [`../locations/Death Frontier.md`](../locations/Death Frontier.md) + Vellweb (à créer)
  - Aglis (underwater Wingly) : [`../locations/Aglis.md`](../locations/Aglis.md)
  - Divine Tree : [`../locations/Divine Tree.md`](../locations/Divine Tree.md)

## Questions ouvertes

- **Tesfer Realm canon** — encompassing world ? cosmological lore ? Lien spiritual/physical planes ? À investiguer.
- **Planet name canon mystère** — never given. Design choice ? Future reveal ? Anonymous canon ?
- **6 lands east canon (Azeel/Ediroso/Losta/Nissel/Seilnder/Vidalio)** — story content ? Lore mention ? Disc 4 reference ? Possible Mode Survival exclusive expansion or post-game DLC content for Damia ?
- **Fourtos Ocean lore** — sea bodies canon. Ship routes Queen Fury cohérent ? Currents / hazards ?
- **Aquaria Coral Reef lore** — bordure marine. Lien Aglis underwater Wingly city ? Coral Reef = where Aglis hidden ?
- **Broken Islands canon explored ?** — large island ripped Dragon Campaign. Visited Disc 4 ? Mode Story exploration ? Mode Survival arène ?
- **3 Divine Moon Objects canon (post-war Wingly gift)** :
  - Mille Seseau : Moon Mirror (Tower of Flanvel) ✅ confirmed
  - Serdio : ? (probable Basil royals — Albert family)
  - Tiberoa : ? (King Zior royals Fletz)
    → 2 items à identifier canon. À documenter `lore/moon-objects.md` (à créer).
- **Winglies hiding magic canon** — implication design : Forest of Winglies + Aglis (underwater) + Ulara (Spring Breath revealed Rose Choker) + Zenebatos = 4 Wingly cities canon hidden. **5th unknown** ? Cohérent 5 floating cities Dragon Campaign + Flanvel mobile fortress canon ?
- **Gloriano-Death Frontier boundary canon** — nord (Gloriano ruins) vs sud (Death Frontier desert). À cartographier précisément.
- **Vellweb position canon** — capital of oppressed Dragon Campaign. Probable in Gloriano north (ruins canon). À documenter `locations/Vellweb.md` (à créer).
- **Fort Magrad location canon** — Diaz war declaration. Probable Gloriano canon. À documenter `locations/Fort Magrad.md` (à créer).
- **Kadessa current location canon** — Wingly Royal Capital ripped Dragon Campaign. Visited Disc 4 ? Possible ruins explorable ?
- **Suncrest Island lore** — Regole sea Dragon territory canon. Détails géographie ?
- **Prison Island lore** — Lenus arc canon. Detail location ?
- **Wingly cities mapping** : 4 connues (Aglis, Ulara, Forest of Winglies, Zenebatos). À cartographier sur world map Endiness.
